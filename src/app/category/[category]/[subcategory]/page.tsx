...
type FilterGroup = { title: string; options: FilterOption[] };

// Define available categories and subcategories
const categoryData: Record<
    string,
    { name: string; subcategories: Record<string, { name: string; description: string }> }
> = {
    "cooking-equipment": {
        name: "Cooking Equipment",
        subcategories: {
            ovens: { name: "Ovens", description: "Commercial ovens and ranges" },
            grills: { name: "Grills & Griddles", description: "Grills, griddles, and charbroilers" },
            fryers: { name: "Fryers", description: "Commercial deep fryers" },
            ranges: { name: "Ranges", description: "Gas and electric ranges" },
        },
    },
    refrigeration: {
        name: "Refrigeration",
        subcategories: {
            refrigerators: { name: "Refrigerators", description: "Commercial refrigerators" },
            freezers: { name: "Freezers", description: "Commercial freezers" },
            "display-coolers": { name: "Display Coolers", description: "Glass door display refrigerators" },
            "ice-machines": { name: "Ice Machines", description: "Ice makers and dispensers" },
        },
    },
    "food-prep": {
        name: "Food Preparation",
        subcategories: {
            mixers: { name: "Mixers", description: "Stand mixers and planetary mixers" },
            processors: { name: "Food Processors", description: "Food processors and choppers" },
            slicers: { name: "Slicers", description: "Meat and vegetable slicers" },
            "prep-tables": { name: "Prep Tables", description: "Stainless steel prep tables" },
        },
    },
};
...
export default function SubcategoryPage({ params }: SubcategoryPageProps) {
    ...
    const subcategoryInfo = category?.subcategories[params.subcategory] || {
        name: params.subcategory.replace("-", " ").replace(/\b\w/g, (l) => l.toUpperCase()),
    ...
    const filterConfig: FilterGroup[] = [
        ...
        },
        {
            title: "Capacity",
            options: [
                { value: "small", label: "Small (0-20L)" },
                { value: "medium", label: "Medium (20-50L)" },
                { value: "large", label: "Large (50-100L)" },
                { value: "extra-large", label: "Extra Large (100L+)" },
            ],
        },
        {
            title: "Power Type",
            ...
            <div className="flex-grow">
                ...
                <div className="w-full px-2 sm:px-4 lg:px-8 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-theme-text-secondary">{subcategoryInfo.description}</p>
                    </div>
